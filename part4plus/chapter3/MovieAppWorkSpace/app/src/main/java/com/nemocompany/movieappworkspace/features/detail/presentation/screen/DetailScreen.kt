package com.nemocompany.movieappworkspace.features.detail.presentation.screen
...
import com.nemocompany.movieappworkspace.features.detail.presentation.input.IDetailViewModelInputs
import com.nemocompany.movieappworkspace.features.detail.presentation.output.MovieDetailState
import com.nemocompany.movieappworkspace.ui.components.buttons.PrimaryButton
import com.nemocompany.movieappworkspace.ui.components.buttons.SecondaryButton
import com.nemocompany.movieappworkspace.ui.components.movie.MovieMeta
...
fun MovieDetail(
    ...
    Scaffold(
        ...
        Column(
            modifier = Modifier
                .padding(
                    // 최신버전에 의해 추가한 vertical, TopAppBar라서 innerPadding을 Top만 줬음
