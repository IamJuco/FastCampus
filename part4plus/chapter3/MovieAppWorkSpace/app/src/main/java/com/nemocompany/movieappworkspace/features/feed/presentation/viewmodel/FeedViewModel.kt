package com.nemocompany.movieappworkspace.features.feed.presentation.viewmodel
...
import com.nemocompany.movieappworkspace.features.feed.presentation.output.IFeedViewModelOutput
...
class FeedViewModel @Inject constructor(
    ...
    private val _feedState: MutableStateFlow<FeedState> =
        MutableStateFlow(FeedState.Loading) // 모든 첫 상태는 Loading을 보여줄것임
    override val feedState: StateFlow<FeedState> get() = _feedState

    // 유저로부터 입력을 받아서 Fragment 에서 액션을 수행하기 위한 Flow
